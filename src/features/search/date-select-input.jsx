        ...
        render={({ field }) => (
          <>
            <PopoverTrigger asChild>
              <FormItem className="h-12 w-full flex items-center px-4 py-2 rounded-md bg-background border border-gray-300 focus-within:ring-2 focus-within:ring-yellow-500">
                <FormControl>
